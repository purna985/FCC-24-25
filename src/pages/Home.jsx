  ...
  return (
    <div className=" overflow-x-hidden ">
      ...
      <div className="flex h-auto mb-[10%] md:flex-row flex-col w-full justify-start items-center">
        ...
        <img className="md-1:hidden md:absolute top-[10vh] md:top-[30vh] md:left-[50vw] rotate-[60deg] " src={rupeeBlur} alt="" height="50" width="50" title="svg" />
        <img className="md-1:hidden md:absolute md:top-[80vh] md:right-[10vw] " src={rupeeBlur} alt="" height="50" width="50" title="svg" />
        <img className="md-1:hidden md:absolute md:top-[20vh] md:left-[20vw] " src={rupeeBlur} alt="" height="50" width="50" title="svg" />
        <img className="md-1:hidden md:absolute md:top-[80vh] md:right-[10vw] " src={rupeeBlur} alt="" height="50" width="50" title="svg" />
        ...
        <div className="font-rosario  md-1:w-auto lg:w-1/2 w-full text-center self-center h-1/2 justify-between items-center">
          <div className="titles  ">
            <p
              className="text-[#1270ed] text-[5.5rem] md-1:text-[4rem] sm:text-[2.5rem] leading-100p text-center  mb-5">Finance
              and Consulting Club</p>
            <p
              className="font-rosario font-light  text-[2.5rem] leading-normal text-center">IIT
              Hyderabad</p>
          </div>
          <Link to='/horizon'
            className="shadow-[0_0_12px_rgba(69,115,213,0.6)] hover:shadow-[0_0_25px_rgba(69,115,213,0.6)] w-fit md:w-1/2 my-10 text-3xl  md:text-[2.2rem] text-white bg-[#172EFF] rounded-[1.5625rem] flex justify-center items-center px-5 mx-auto"
          >
            Horizon 25&apos; <img src={rightArrow} className=' md:w-20 md:h-20' alt="" />
          </Link>
        ...
        <div className="cardbox w-full md:w-1/2 h-1/4 md:h-full flex justify-center mx-auto">
          <div className="horizon-card  p-6 md:p-10 md:px-[20px] md:pt-0 md:pb-[20px] flex flex-col justify-center font-rosario w-[70%] md:w-[90%] md:max-w-[420px] md:min-w-[300px] h-auto md:h-[17rem] rounded-[2rem] border border-solid border-[#ffffff41] bg-gray-500 "
      ...
      <div
        className="relative w-full h-[50vh] md:h-auto md:p-[1%] flex items-center justify-center flex-col overflow-hidden mix-blend-exclusion"
        ...
        <div
          className="flex font-rosario md:w-[90%] md:px-[2%] text-[3rem] md:text-[5rem] text-center md:text-start w-full leading-[110%]  mt-5 mx-auto md:mx-none ">
          <p className='mx-auto md:mx-0'>So, <br className='hidden md:flex' /> Who are we?</p></div>
        <div
          className="w-[90%] h-auto text-[f2f2f2] md:text-[2.2rem] text-lg font-rosario font-light leading-normal p-[2%] tracking-[200%]">
          <p className='text-left pb-5'>The
            ...
            consulting, product management and continual progress.</p>
          <p className='text-left pb-5'>Our dedicated team plans a variety of events, such
            ...
            finance, consulting, and product management domains.</p>
        </div>
      </div>
      ...
      {/* What we do cards */}
      <div className="h-auto w-full flex flex-col items-center justify-center font-rosario  py-4 my-4 container-fluid" id="what-we-do">
