...
const NewsCard = ({id,title,description,date,image}) => {
  return (
    <div className=' relative md:h-[26rem] lg:h-[24rem] w-[22rem] md:w-[50%] mx-auto bg-[#114791] rounded-xl flex-col-reverse md:flex flex md:flex-row  overflow-hidden ' >
      ...
      <Card className="dark border-none md:h-[22rem] w-auto md:w-1/2 shadow-none bg-transparent md:p-4 bg-[#114791] flex flex-col justify-evenly " >
        <CardHeader>
          <CardTitle className=" text-lg md:my-2" >{title}</CardTitle>
