...
>
    <h2 className="flex items-center gap-x-3 text-lg md:text-lg font-roboto text-white mb-4">
        <div class="w-5 h-5 bg-[#CDFE64] rounded-full"></div>
        COMING SOON
    </h2>

    <h2 className="flex items-center gap-x-3 text-4xl md:text-5xl font-title font-bold bg-gradient-to-r from-[#81BD01] via-[#F3FFD8] to-[#D9FE8B] bg-clip-text text-transparent text-lime-400 mb-4">
        Horizon 2026
