    ...
    <div className="my-10 pb-10 bg-black w-full z-20" >
      ...
      <div className='md:flex justify-evenly items-center gap-5 hidden  mx-auto w-auto z-20 bg-black' >
        <blockquote
          ...
          data-instgrm-permalink="https://www.instagram.com/p/C7mM_T6I74L/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==
"
        ...
        <blockquote
          className="instagram-media z-50"
          data-instgrm-permalink=" https://www.instagram.com/p/C8Ck63GSRcJ/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==
"
          data-instgrm-version="14"
        ...
        <blockquote
          ...
          data-instgrm-permalink="https://www.instagram.com/p/C8cFrBtyoZK/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA=="
          data-instgrm-version="14"
          style={{ maxWidth: '540px', margin: '0 auto', filter: ' brightness(0.8)' }}
        />
      </div>
