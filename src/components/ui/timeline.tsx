...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-[90%] md:w-full mx-auto bg-transparent font-sans md:px-10"
      ref={containerRef}
      id="timeline"
    >
      <div className="max-w-7xl mx-auto py-5 px-4 md:px-8 lg:px-10">
        <h2 className="text-3xl md:text-4xl mt-4 text-white max-w-4xl">
          Timeline of Events for 2025
        </h2>
        <p className="text-neutral-300 text-md md:text-base max-w-sm">
          Explore the schedule of events for Horizon 2025.
        </p>
      </div>
        ...
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3 className="md:hidden block text-2xl mb-4 text-left font-bold text-blue-500 dark:text-blue-500">
                {item.title}
              </h3>
