  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className=" mt-7 w-[80%] md:w-full flex justify-center md:justify-end gap-10 mx-auto md-4:flex-wrap">
          <div className="w-auto md:w-fit flex-col flex gap-3">
            <ul className="flex flex-col gap-1 text-[1rem] mt-2 mx-6">
