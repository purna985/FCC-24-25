...
export const NewsLetterContentData = [
  ...
  },
  {
    ...
    content: [
      'A shocking revelation highlights that 20 million tonnes of grain meant for the Public Distribution System ' +
      '(PDS) never reached the intended beneficiaries. This finding, published by the Indian Council for Research on ' +
      'International Economic Relations, indicates that 28% of all grains are diverted to open markets or exports, ' +
      'resulting in a staggering loss of ₹69,000 crore.\n\nThe report, based on data from the Food Corporation of ' +
      'India and the Household Expenditure Consumption Survey, shows that despite advancements in digitization, ' +
      'significant leakage of subsidized grains persists.\n\nNotably, states like Bihar and West Bengal have made ' +
      'remarkable progress, reducing leakage rates from around 70% to 19% (Bihar) and 9% (West Bengal) over the past ' +
      'decade. However, states such as Arunachal Pradesh, Nagaland, and Gujarat continue to experience high leakages ' +
      'due to limited digitization. Uttar Pradesh tops the list in absolute terms, with 33% of its PDS grains being ' +
      'diverted.\n\nThis report underscores the urgent need for systemic reforms to ensure that subsidized grains ' +
